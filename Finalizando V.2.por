programa
{
	...
	funcao real salariobruto(real setor, inteiro dependentes){

		retorne setor + (dependentes*50)
	}
     ...
     } funcao inicio()
	{
		...
		escreva("Qual é seu atual setor: 1- administrativo, 2- cormecial, 3- financeiro, 4- TI, 5- Operacional, 6- Logistica e transporte: ")
          ...
          se (setores == 1 ){
          administrativo = 2.890
          administrativo = soma_area
		...
		setores_micro = "comercial"
	     ...
	     setores_micro = "TI"
          ...
          senao se(setores == 5) {
	     operacional = 2.470
	     operacional = soma_area
	     setores_micro = "operacional"
          }
          senao se(setores == 6) {
	     logistica_transporte = 2.700
	     soma_area = logistica_transporte
	     setores_micro = "logistica transporte"
          }
          salario_ini = salario(horas_trabalhadas, horas_mes)
		salario_bruto = salariobruto(soma_area, dependentes)
